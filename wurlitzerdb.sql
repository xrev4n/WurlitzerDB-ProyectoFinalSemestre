...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2023 a las 20:28:49
...
--
CREATE DATABASE IF NOT EXISTS `wurlitzerdb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wurlitzerdb`;
...
--
-- Base de datos: `wurlitzerdb2`
--
CREATE DATABASE IF NOT EXISTS `wurlitzerdb2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `wurlitzerdb2`;
COMMIT;
